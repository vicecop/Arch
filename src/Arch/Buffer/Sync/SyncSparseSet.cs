...
///    represents an <see cref="Entity"/> with its index in the <see cref="SyncSparseSet"/>.
/// </summary>
internal readonly struct SparseEntity
{
    ...
    /// <param name="index">The index inside the <see cref="SyncSparseSet"/>.</param>
...
/// </summary>
internal class SyncSparseArray
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="SyncSparseArray"/> class
    ...
    public SyncSparseArray(ComponentType type, int capacity = 64)
    {
        Type = type;
    ...
    /// <summary>
    ///     Gets the <see cref="ComponentType"/> the <see cref="SyncSparseArray"/> stores.
    /// </summary>
    public ComponentType Type { get; }

    /// <summary>
    ///     Gets the total number of elements the <see cref="SyncSparseArray"/> can hold without resizing.
    /// </summary>
    public int Capacity { get; private set; }

    // NOTE: Should this be `Length` to follow the existing `Array` API?
    /// <summary>
    ///     Gets the total number of elements in the <see cref="SyncSparseArray"/>.
    /// </summary>
    ...
    /// <summary>
    ///     Gets an array of components contained by the <see cref="SyncSparseArray"/>.
    /// </summary>
...
///     Stores a series of <see cref="SyncSparseArray"/>'s and their associated components.
/// </summary>
internal class SyncSparseSet
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="SyncSparseSet"/> class
    ///     with an optional initial <paramref name="capacity"/> (default: 64).
    /// </summary>
    /// <param name="capacity">The initial capacity.</param>
    public SyncSparseSet(int capacity = 64)
    {
        Capacity = capacity;
        ...
        Components = Array.Empty<SyncSparseArray>();
    }

    /// <summary>
    ///     Gets the total number of elements the <see cref="SyncSparseSet"/> initially can hold.
    /// </summary>
    public int Capacity { get; }

    // NOTE: Should this be `Count` to follow the existing `ICollection` API?
    /// <summary>
    ///     Gets the total number of elements in the <see cref="SyncSparseSet"/>.
    /// </summary>
    public int Count { get; private set; }

    /// <summary>
    ///     Gets a <see cref="List{T}"/> of all <see cref="SparseEntity"/> instances in the <see cref="SyncSparseSet"/>.
    /// </summary>
    public List<SparseEntity> Entities { get; }

    /// <summary>
    ///     Gets the total number of <see cref="SyncSparseArray"/> instances in the <see cref="SyncSparseSet"/>.
    /// </summary>
    public int UsedSize { get; private set; }

    /// <summary>
    ///     Gets or sets an array containing used <see cref="SyncSparseArray"/> indices.
    /// </summary>
    public int[] Used;

    /// <summary>
    ///     Gets or sets an array containing <see cref="SyncSparseArray"/> instances.
    /// </summary>
    public SyncSparseArray[] Components;
    ...
    /// <summary>
    ///     Adds an <see cref="Entity"/> to the <see cref="SyncSparseSet"/>.
    /// </summary>
    /// <param name="entity">The <see cref="Entity"/>.</param>
    /// <returns>The index in the <see cref="SyncSparseSet"/>.</returns>
    ...
    /// <summary>
    ///     Adds an <see cref="SyncSparseArray"/> to the <see cref="Components"/> list and updates the <see cref="Used"/> properly.
    /// </summary>
    /// <param name="type">The <see cref="ComponentType"/> of the <see cref="SyncSparseArray"/>.</param>

    private void AddSparseArray(ComponentType type)
    {
        Components[type.Id] = new SyncSparseArray(type, type.Id);
    ...
    /// <summary>
    ///     Checks whether a <see cref="SyncSparseArray"/> for a certain <see cref="ComponentType"/> exists in the <see cref="Components"/>.
    /// </summary>
    ...
    private SyncSparseArray GetSparseArray(ComponentType type)
    {
    ...
    /// <summary>
    ///     Clears the <see cref="SyncSparseSet"/>.
    /// </summary>
